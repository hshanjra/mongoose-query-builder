...
import { UserDocument, PostDocument } from "./test-utils/models";
...
describe("Integration Tests for QueryBuilder", () => {
  ...
  beforeAll(async () => {
    ...
    Post = mongoose.model<PostDocument>("Post", postSchema);
  });
  ...
  describe("query operations", () => {
    ...
    it("should find all documents", async () => {
      ...
      const { data, metadata } = await queryBuilder.graph<PostDocument>({
        entity: "Post",
      });
    ...
    it("should support field selection", async () => {
      ...
      expect(Object.prototype.hasOwnProperty.call(data[0], "content")).toBe(
        false
      );
      expect(Object.prototype.hasOwnProperty.call(data[0], "viewCount")).toBe(
        false
      );
    });
    ...
    it("should support population with field selection", async () => {
      ...
      expect(
        data[0].author &&
          Object.prototype.hasOwnProperty.call(data[0].author, "email")
      ).toBe(false);
