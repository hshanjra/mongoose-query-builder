...
import { UserDocument } from "./test-utils/models";
...
describe("QueryBuilder", () => {
  ...
  describe("query operations", () => {
    ...
    it("should find all documents", async () => {
      ...
      const { data, metadata } = await queryBuilder.graph<UserDocument>({
        entity: "User",
      });
    ...
    it("should support field selection", async () => {
      ...
      expect(Object.prototype.hasOwnProperty.call(data[0], "isActive")).toBe(
        false
      );
    });
